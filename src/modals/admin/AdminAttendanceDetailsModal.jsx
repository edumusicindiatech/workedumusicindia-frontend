    ...
    const renderSchoolsList = () => (
        <div className="flex flex-col h-full">
            ...
            <div className="space-y-3">
                ...
                {monthData.schools.length === 0 && <div className="p-8 text-center text-muted-foreground border border-dashed border-border rounded-xl text-sm">No schools assigned for this month.</div>}
            </div>
        </div>
    );
