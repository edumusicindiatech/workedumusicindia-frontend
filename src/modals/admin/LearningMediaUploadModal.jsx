...
const LearningMediaUploadModal = ({ isOpen, onClose }) => {
    ...
    const handleFileSelect = async (e) => {
        ...
        const MAX_COMBINED_SIZE = 2 * 1024 * 1024 * 1024; // 2 GB
                    ...
                    <div className="space-y-3">
                        ...
                        {files.length === 0 ? (
                            ...
                            >
                                ...
                                <p className="text-[11px] font-bold text-muted-foreground mt-1.5 text-center uppercase tracking-tighter opacity-60">Max 2 GB combined</p>
                            </div>
                        ) : (
                            <div className="space-y-3">
