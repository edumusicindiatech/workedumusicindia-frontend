...
// --- Helper function to sort days chronologically ---
const sortDaysChronologically = (daysArray) => {
    ...
    return [...daysArray].sort((a, b) => {
        const orderA = dayOrder[a] || 8;
        const orderB = dayOrder[b] || 8;
                                        ...
                                        <div className="min-w-0 flex-1 space-y-3">
                                            ...
                                            <div className="flex flex-wrap gap-2.5 pt-2">
                                                ...
                                                {task.daysAllotted && task.daysAllotted.length > 0 && (
                                                    <span className="px-3 py-1 bg-muted rounded-lg border border-border/50 text-xs font-bold text-foreground flex items-center gap-1.5">
                                                        <CalendarDays className="w-3.5 h-3.5 text-blue-500" /> {sortDaysChronologically(task.daysAllotted).join(', ')}
                                                    </span>
                                                )}
                                            </div>
                                        </div>
