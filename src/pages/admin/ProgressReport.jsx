...
const ProgressReport = () => {
    ...
    const handleExportExcel = async () => {
        ...
        const toastId = toast.loading(t('progress_report.toasts.export_preparing', 'Preparing beautiful report...'));

        try {
            // 1. Fetch the raw binary data (blob) from your backend
            ...
            // 2. Catch backend JSON errors that got accidentally parsed as blobs
            ...
            // 4. DO NOT PARSE IT. Download the raw, styled ExcelJS blob directly!
            ...
            toast.error(err.message || t('progress_report.toasts.export_fail', 'Failed to export.'), { id: toastId });
        }
    };

    // --- ALPHABETICAL FILTER APPLIED HERE ---
